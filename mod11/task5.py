...
if planet_volume > earth_volume:
    print(
        "Объем планеты Земля меньше в",
        (1, round(earth_volume / planet_volume, 3)),
        round(planet_volume / earth_volume, 3),
        "раз",
    )

elif planet_volume < earth_volume:
    print(
        "Объем планеты Земля больше в ", round(earth_volume / planet_volume, 3), "раз"
    )
